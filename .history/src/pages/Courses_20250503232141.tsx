        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-white/80 mb-8">
              Conheça os cursos disponíveis no FlashClip e escolha o que melhor se adapta às suas necessidades e objetivos.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 text-center">
            <p className="text-white/70 mb-8 max-w-2xl mx-auto">
              Não sabe qual curso escolher? Faça nosso teste de perfil para descobrir qual linguagem combina mais com você.
            </p>
            ...
            <table className="w-full min-w-[800px] border-collapse">
              <thead>
                <tr className="border-b border-white/10">
                  ...
                  <th className="py-4 px-6 text-left text-white">Carga Horária</th>
                  <th className="py-4 px-6 text-left text-white">Formato</th>
                  <th className="py-4 px-6 text-left text-white">Melhor Para</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-white/10 hover:bg-white/5">
                  ...
                  <td className="py-4 px-6 text-white/80">20 horas</td>
                  <td className="py-4 px-6 text-white/80">Presencial</td>
                  <td className="py-4 px-6 text-white/80">Aplicações desktop e empresariais</td>
                </tr>
                <tr className="border-b border-white/10 hover:bg-white/5">
                  <td className="py-4 px-6 text-tech-neon">TypeScript</td>
                  <td className="py-4 px-6 text-white/80">Intermediário</td>
                  <td className="py-4 px-6 text-white/80">16 horas</td>
                  <td className="py-4 px-6 text-white/80">Virtual</td>
                  <td className="py-4 px-6 text-white/80">Desenvolvimento web front-end</td>
                </tr>
                <tr className="border-b border-white/10 hover:bg-white/5">
                  <td className="py-4 px-6 text-tech-neon">Go</td>
                  <td className="py-4 px-6 text-white/80">Intermediário</td>
                  <td className="py-4 px-6 text-white/80">18 horas</td>
                  <td className="py-4 px-6 text-white/80">Presencial</td>
                  <td className="py-4 px-6 text-white/80">Sistemas de alta performance</td>
                </tr>
                <tr className="border-b border-white/10 hover:bg-white/5">
                  <td className="py-4 px-6 text-tech-neon">Ruby</td>
                  <td className="py-4 px-6 text-white/80">Iniciante</td>
                  <td className="py-4 px-6 text-white/80">16 horas</td>
                  <td className="py-4 px-6 text-white/80">Virtual</td>
                  <td className="py-4 px-6 text-white/80">Desenvolvimento web rápido</td>
                </tr>
                <tr className="border-b border-white/10 hover:bg-white/5">
                  <td className="py-4 px-6 text-tech-neon">Prolog</td>
                  <td className="py-4 px-6 text-white/80">Avançado</td>
                  <td className="py-4 px-6 text-white/80">12 horas</td>
                  <td className="py-4 px-6 text-white/80">Presencial</td>
                  <td className="py-4 px-6 text-white/80">IA simbólica e lógica computacional</td>
                </tr>
              </tbody>
            </table>
          </div>
