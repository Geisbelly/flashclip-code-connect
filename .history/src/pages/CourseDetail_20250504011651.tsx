...
const CourseDetail = () => {
  ...
  const [instructor, setInstructor] = useState<InstructorProps[]>(null);
  const [courseSchedules, setCourseSchedules] = useState<CourseProps[]>([]);
  ...
  useEffect(() => {
    ...
    if (foundCourse) {
      ...
      // Match instrutores completos
      const foundInstructors = instructorsData.filter(inst =>
        foundCourse.instructor.includes(inst.id || inst.name) // ou outro identificador único
      );
      setInstructor(foundInstructors);
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap gap-6 text-white/70">
              ...
              {course.instructor.map((req, index) => (<div className="flex items-center gap-2">
              ...
              <div className="space-y-8">
                ...
                {instructor && (
                  <div className="p-6 rounded-lg border border-white/10 bg-tech-blue-light/30 backdrop-blur-sm">
                    ...
                    {instructor.map((inst: InstructorProps, idx: number) => (
                    ...
                    {/* <p className="text-white/80 text-sm mb-4">{instructor.bio}</p> */}
