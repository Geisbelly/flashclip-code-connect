...
const CourseDetail = () => {
  ...
  useEffect(() => {
    ...
    // Find instructor
    if (foundCourse) {
      const foundInstructor = instructorsData.find(i => 
        i.name === foundCourse.instructor
      );
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="space-y-8">
                ...
                {instructor && (
                  <div className="p-6 rounded-lg border border-white/10 bg-tech-blue-light/30 backdrop-blur-sm">
                    <h3 className="text-xl font-bold mb-4 text-white">Instrutor</h3>
                    
                    <div className="flex items-center gap-4 mb-4">
                      <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-tech-neon/30">
                        <img 
