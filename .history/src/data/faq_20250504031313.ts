...
export const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "A instituição disponibiliza computadores equipados com todos os softwares necessários. Para os cursos virtuais, você precisará de um computador com acesso à internet e os requisitos mínimos informados por email após a inscrição."
  },
  {
    id: "faq5",
