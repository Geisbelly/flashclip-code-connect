...
export const coursesData: CourseProps[] = [
  {
    ...
    level: "Introdução",
    hours: 3,
    instructor: ["Mota","Arthur A.","David","Sávio Ramon","Arthur T.", "Lucas Nascimento"],
  ...
  },
  {
    ...
    level: "Introdução",
    hours: 3,
    instructor: ["Eduardo S.","Adeulvado","Samuel","Pedro Augusto"],
    prerequisites: ["Nenhum"]
  },
  {
    id: "go",
    ...
    level: "Introdução",
    hours: 3,
    instructor: ["Anne","Victor Tavares","Pedro Paulo","Jonathan","Kauã Gabriel", "Carlos"],
    prerequisites: ["Nenhum"]
  },
  {
    id: "ruby",
    ...
    level: "Introdução",
    hours: 3,
    instructor: ["Julia","Ítalo","Sergio","Hugo","Regis Filho","Victor da Mata"],
    prerequisites: ["Nenhum"]
  },
  {
    id: "prolog",
