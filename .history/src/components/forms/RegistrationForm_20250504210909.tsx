...
const RegistrationForm = () => {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    form.method = 'POST';
    form.target = '_self'; // ou '_blank' para abrir nova aba
  
    const entries = {
      "entry.2005620554": values.email,
      "entry.1045781291": values.fullName,
      "entry.1065046570": values.phone,
      "entry.1166974658": values.miniCourse,
      "entry.839337160": values.institution,
    };
