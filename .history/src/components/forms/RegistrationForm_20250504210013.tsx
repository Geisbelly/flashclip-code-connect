...
const RegistrationForm = () => {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    const filledUrl = `${formUrl}?entry.2005620554=${encodeURIComponent(values.email)}&entry.1045781291=${encodeURIComponent(values.fullName)}&entry.1065046570=${encodeURIComponent(values.phone)}&entry.1166974658=${encodeURIComponent(values.course)}&entry.839337160=${encodeURIComponent(values.institution)}&entry.1525512698=${encodeURIComponent(values.miniCourse)}`;

    // const formData = new FormData();
    // formData.append('entry.605337776', values.email);
    // formData.append('entry.144064944', values.fullName);
    // formData.append('entry.1390284158', values.phone);
    // formData.append('entry.1278160725', values.course);
    // formData.append('entry.885928829', values.institution);
    // formData.append('entry.1525512698', values.miniCourse);
    //formData.append('entry.999999999', values.acceptTerms ? 'Sim' : 'Não');

    // if (values.course === "outro") {
    //   formData.append("entry.1278160725", "__other_option__");
    //   formData.append("entry.1278160725_other_option_response", values.customCourse || "");
    // }

    // if (values.institution === "outro") {
    //   formData.append("entry.885928829", "__other_option__");
    //   formData.append("entry.885928829_other_option_response", values.customInstitution || "");
    // }
