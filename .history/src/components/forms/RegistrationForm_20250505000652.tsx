...
import listarRespfetchSheetCSVostasSheet from '@/lib/googleServices'
...
const RegistrationForm = () => {
  ...
  useEffect(() => {
      async function teste() {
        const dados = await listarRespostasSheet();
        const listaStrings = dados.values?.flat() || []; // Transform Schema$ValueRange to string[]
        setLista(listaStrings);
      }
      teste();
    }, []);
