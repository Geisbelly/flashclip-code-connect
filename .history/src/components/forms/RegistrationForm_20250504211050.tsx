...
const RegistrationForm = () => {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    const filledUrl = `${formUrl}?entry.605337776=${encodeURIComponent(values.email)}&entry.144064944=${encodeURIComponent(values.fullName)}&entry.1390284158=${encodeURIComponent(values.phone)}&entry.1278160725=${encodeURIComponent(values.course)}&entry.839337160=${encodeURIComponent(values.institution)}&entry.1166974658=${encodeURIComponent(values.miniCourse)}`;
