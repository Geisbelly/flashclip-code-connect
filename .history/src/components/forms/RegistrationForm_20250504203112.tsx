...
const RegistrationForm = () => {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    formData.append('entry.2005620554', values.email);
    formData.append('entry.1045781291', values.fullName);
    formData.append('entry.1065046570', data.phone);
    formData.append('entry.1166974658', data.course);
    formData.append('entry.839337160', data.institution);
    formData.append('entry.1166974658', data.minicourse);
    formData.append('entry.999999999', data.acceptTerms ? 'Sim' : 'Não');
