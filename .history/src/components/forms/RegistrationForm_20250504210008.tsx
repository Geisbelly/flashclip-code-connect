...
const RegistrationForm = () => {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    const filledUrl = `${formUrl}?entry.2005620554=${encodeURIComponent(values.email)}&entry.1045781291=${encodeURIComponent(values.fullName)}&entry.1065046570=${encodeURIComponent(values.phone)}&entry.1166974658=${encodeURIComponent(values.course)}&entry.885928829=${encodeURIComponent(values.institution)}&entry.1525512698=${encodeURIComponent(values.miniCourse)}`;
