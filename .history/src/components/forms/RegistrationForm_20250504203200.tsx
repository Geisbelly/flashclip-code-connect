...
const RegistrationForm = () => {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    formData.append('entry.1166974658', values.course);
    formData.append('entry.839337160', values.institution);
    formData.append('entry.1166974658', values.miniCourse);
    formData.append('entry.999999999', values.acceptTerms ? 'Sim' : 'Não');

    if (values.course === "outro") {
      formData.append("entry.1166974658", "__other_option__");
      formData.append("entry.1166974658_other_option_response", values.customCourse || "");
    }
