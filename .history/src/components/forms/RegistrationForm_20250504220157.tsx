...
const RegistrationForm = () => {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    const formUrl = `https://docs.google.com/forms/d/e/1FAIpQLSd11jX94D_SORUkxWZ6j_4kH2vCK2NmJYua-L_MKxsQUFjCeg/formResponse?entry.605337776=${values.email}`;
    form.method = 'POST';
    form.target = '_self';
  
    const data = new URLSearchParams();

      data.append('entry.605337776', values.email);
      data.append('entry.144064944', values.fullName);
      data.append('entry.1390284158', values.phone);
      data.append('entry.1278160725', values.course === 'outro' ? '__other_option__' : values.course);
      data.append('entry.885928829', values.institution === 'outro' ? '__other_option__' : values.institution);
      data.append('entry.1525512698', values.miniCourse);
