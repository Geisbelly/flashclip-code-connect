...
const formSchema = z.object({
  ...
  studentId: z.string().min(5, { message: "A matrícula deve ter pelo menos 5 caracteres." }),
...
const RegistrationForm = () => {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    formData.append("entry.556677889", values.studentId);     // Matrícula
    ...
    if (values.course === "outro") {
      ...
      formData.append("entry.667788990", values.course);
    }
            ...
            <FormItem>
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                ...
                <SelectContent className="bg-tech-blue-light border-white/10">
                  ...
                  <SelectItem value="outro" className="text-white hover:text-tech-neon">Outro</SelectItem>
                </SelectContent>
              </Select>
              <FormMessage />
            </FormItem>
