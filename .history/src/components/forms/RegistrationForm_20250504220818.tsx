...
const RegistrationForm = () => {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    const values = {
      ...
      fullName: 'Geis Asynca',
      phone: '63933003642',
      course: 'Outro', // ou 'Ciência da Computação', etc.
      courseOther: 'Engenharia de Dados', // se 'Outro' for selecionado
      institution: 'Outro', // ou 'UFT', etc.
      institutionOther: 'IFTO Palmas', // se 'Outro' for selecionado
      miniCourse: 'Prolog'
    };
    ...
    if (values.course === 'Outro') {
      ...
      data.append('entry.142913211.other_option_response', values.courseOther);
    } else {
    ...
    if (values.institution === 'Outro') {
      ...
      data.append('entry.601039953.other_option_response', values.institutionOther);
    } else {
