...
const RegistrationForm = () => {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    const filledUrl = `${formUrl}?entry.605337776=${encodeURIComponent(values.email)}&entry.1045781291=${encodeURIComponent(values.fullName)}&entry.1065046570=${encodeURIComponent(values.phone)}&entry.1166974658=${encodeURIComponent(values.course)}&entry.839337160=${encodeURIComponent(values.institution)}&entry.1166974658=${encodeURIComponent(values.miniCourse)}`;
