...
import { google } from 'googleapis'; // Ensure googleapis is installed via npm
...
const auth = new google.auth.GoogleAuth({
 ...
 async function listarRespostasSheet() {
    const authClient = await auth.getClient();
    const sheets = google.sheets({ version: 'v4', auth: authClient as google.auth.OAuth2Client });
...
const RegistrationForm = () => {
  ...
  const getDadosForm = 'https://forms.googleapis.com/v1/forms/1prpYABSkE6JOg96pHJT1MKZ5HbHUwjdlGpou3jlgc0A/responses'
