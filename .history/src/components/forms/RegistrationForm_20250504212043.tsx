...
const RegistrationForm = () => {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    form.action = 'https://docs.google.com/forms/d/e/1FAIpQLSd11jX94D_SORUkxWZ6j_4kH2vCK2NmJYua-L_MKxsQUFjCeg/formResponse';
    form.method = 'POST';
    form.target = '_self';
  ...
  return (
    <Form {...form}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSd11jX94D_SORUkxWZ6j_4kH2vCK2NmJYua-L_MKxsQUFjCeg/viewform?embedded=true" width="640" height="1910" frameborder="0" marginheight="0" marginwidth="0">Carregando…</iframe>
          <FormField
            control={form.control}
            name="phone"
            render={({ field }) => (
