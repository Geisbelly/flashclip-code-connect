...
const Footer = () => {
  return (
    <footer className="bg-tech-blue-light/30 pt-12 pb-8 border-t border-white/10">
        ...
        <div className="mt-12 pt-6 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex gap-4 mt-4 md:mt-0">
              <FooterSmallLink to="/termos">Termos de Uso</FooterSmallLink>
              <FooterSmallLink to="/privacidade">Política de Privacidade</FooterSmallLink>
            </div>
          </div>
        </div>
      </div>
