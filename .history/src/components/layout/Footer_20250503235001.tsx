...
const SocialIcon = ({ href, icon }: { href: string; icon: string }) => {
  ...
  return (
    <a 
      ...
      className="w-8 h- rounded-full flex items-center justify-center border border-white/20 text-white/70 hover:text-tech-neon hover:border-tech-neon transition-colors"
    >
