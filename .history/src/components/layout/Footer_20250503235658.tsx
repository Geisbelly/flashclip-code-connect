...
const Footer = () => {
  return (
    <footer className="bg-tech-blue-light/30 pt-0.2 pb-0.2 border-t border-white/10">
...
const SocialIcon = ({ href, icon }: { href: string; icon: string }) => {
  ...
  return (
    <a 
      ...
      className="w-5 h-8 rounded-full flex items-center justify-center border border-white/20 text-white/70 hover:text-tech-neon hover:border-tech-neon transition-colors"
    >
