...
const CourseCard: React.FC<CourseCardProps> = ({ course, featured = false }) => {
  return (
    <Card className={`overflow-hidden justify-betwee border-white/10 bg-tech-blue-light/30 backdrop-blur-sm hover:border-tech-neon/30 transition-all ${
      featured ? 'neon-border' : 'justify-betwee'
    }`}>
