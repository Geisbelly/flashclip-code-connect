              ...
              <div>
                ...
                <div className="space-y-8 text-white/80">
                  ...
                  <ContactInfoCard 
                    title="Email" 
                    content={<>
                      <a href="mailto:contatoflashclip@gmail.com" className="text-tech-neon hover:underline">
                  ...
                  <ContactInfoCard 
                    title="Telefone" 
                    content={<>
                      <a href="https://wa.me/5563984210122" className="text-tech-neon hover:underline">
                        +55 (63) 98421-0122
                      </a><br />
                  ...
                  content={
                    <div className="flex gap-4">
                      ...
                      <svg
                        ...
                        fill="currentColor"
                      >
                        <path d="M16.002 2.944c-7.24 0-13.06 5.822-13.06 13.064 0 2.302.602 4.547 1.744 6.532L2.24 29.059l6.762-2.174a13.01 13.01 0 006.998 2.05h.004c7.241 0 13.06-5.821 13.06-13.063 0-3.486-1.36-6.761-3.83-9.231a12.978 12.978 0 00-9.23-3.96zm.01 23.674h-.002a11.68 11.68 0 01-5.923-1.619l-.423-.25-3.988 1.279 1.203-3.91-.27-.426a11.623 11.623 0 01-1.778-6.208c0-6.431 5.23-11.663 11.661-11.663a11.62 11.62 0 018.229 3.414 11.599 11.599 0 013.428 8.234c-.003 6.431-5.234 11.661-11.665 11.661zm6.095-8.407c-.338-.169-2.01-.99-2.323-1.105-.313-.113-.541-.169-.768.171-.228.338-.88 1.096-1.077 1.321-.199.225-.397.253-.737.084-.34-.17-1.435-.529-2.729-1.686-1.01-.9-1.692-2.016-1.89-2.356-.199-.34-.021-.524.15-.693.155-.154.34-.399.51-.598.17-.199.228-.34.34-.567.113-.226.057-.425-.028-.596-.084-.17-.77-1.845-1.053-2.526-.278-.662-.56-.573-.77-.583-.199-.01-.426-.012-.652-.012-.226 0-.595.085-.906.426-.312.34-1.192 1.153-1.192 2.812 0 1.659 1.219 3.263 1.392 3.493.17.226 2.404 3.64 5.827 5.104.814.348 1.45.556 1.946.709.818.257 1.563.221 2.151.135.656-.098 2.02-.826 2.305-1.623.285-.798.285-1.481.199-1.624-.084-.143-.313-.226-.655-.396z" />
                      </svg>
                      </div>
                    </div>
                  }
...
const SocialLink = ({ href, icon }: { href: string; icon: string }) => {
  const iconMap: Record<string, string> = {
    ...
    whatsapp: "M16.002 2.944c-7.24 0-13.06 5.822-13.06 13.064 0 2.302.602 4.547 1.744 6.532L2.24 29.059l6.762-2.174a13.01 13.01 0 006.998 2.05h.004c7.241 0 13.06-5.821 13.06-13.063 0-3.486-1.36-6.761-3.83-9.231a12.978 12.978 0 00-9.23-3.96zm.01 23.674h-.002a11.68 11.68 0 01-5.923-1.619l-.423-.25-3.988 1.279 1.203-3.91-.27-.426a11.623 11.623 0 01-1.778-6.208c0-6.431 5.23-11.663 11.661-11.663a11.62 11.62 0 018.229 3.414 11.599 11.599 0 013.428 8.234c-.003 6.431-5.234 11.661-11.665 11.661zm6.095-8.407c-.338-.169-2.01-.99-2.323-1.105-.313-.113-.541-.169-.768.171-.228.338-.88 1.096-1.077 1.321-.199.225-.397.253-.737.084-.34-.17-1.435-.529-2.729-1.686-1.01-.9-1.692-2.016-1.89-2.356-.199-.34-.021-.524.15-.693.155-.154.34-.399.51-.598.17-.199.228-.34.34-.567.113-.226.057-.425-.028-.596-.084-.17-.77-1.845-1.053-2.526-.278-.662-.56-.573-.77-.583-.199-.01-.426-.012-.652-.012-.226 0-.595.085-.906.426-.312.34-1.192 1.153-1.192 2.812 0 1.659 1.219 3.263 1.392 3.493.17.226 2.404 3.64 5.827 5.104.814.348 1.45.556 1.946.709.818.257 1.563.221 2.151.135.656-.098 2.02-.826 2.305-1.623.285-.798.285-1.481.199-1.624-.084-.143-.313-.226-.655-.396z",
