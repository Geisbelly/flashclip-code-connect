            ...
            <div className="w-full sm:w-auto">
              <Select value={filter} onValueChange={setFilter}>
                ...
                <SelectContent className="bg-tech-blue-light border-white/10">
                  <SelectItem
                    value="all"
                    className="text-white hover:text-tech-neon"
                  >
                    Todos os Cursos
                  </SelectItem>
            ...
            <div className="grid grid-cols-1 md:grid-cols-1 gap-8 mt-10">
              <div>
                ...
                <div className="prose prose-invert text-white/80">
                  <p>
                    Os cursos presenciais serão realizados no Complexo de
                    Informática da Universidade Ulbra Palmas.
                  </p>
                  <address className="not-italic">
                    <p className="mb-2">
                      1501 Sul - Av. Joaquim Teotônio Segurado
                    </p>
                  ...
                  <p className="mb-2">
                    O evento acontecerá no Complexo de Informática, também
                    conhecido como Engenharia de Software - Ulbra Palmas
                  </p>
                  <iframe
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg mb-8 text-white/80">
              Escolha o curso que mais combina com você e garanta sua vaga agora
              mesmo.
            </p>
            <Button
              asChild
