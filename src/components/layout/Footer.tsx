  ...
  return (
    <footer className="bg-tech-blue-light/30 pt-0 pb-0 border-t border-white/10">
      <div className="container mx-auto px-4 sm:px-6 lg:px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center py-4 gap-6 md:gap-0">
          <p className="text-white/50 text-sm text-center md:text-left">
            © {new Date().getFullYear()}/1 FlashClip. Todos os direitos
            reservados.
          </p>
          ...
          >
            <span className="text-white/50 text-sm hover:underline">
...
const FooterLink = ({
  ...
  <li>
    <Link
      to={to}
      className="text-white/70 hover:text-tech-neon transition-colors"
    >
      {children}
    </Link>
  </li>
...
const FooterSmallLink = ({
  ...
  <Link
    to={to}
    className="text-white/50 hover:text-tech-neon text-sm transition-colors"
  >
    {children}
  </Link>
);
